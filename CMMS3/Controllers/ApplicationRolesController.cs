...
namespace CMMS3.Controllers
{
    public class ApplicationRolesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name")] IdentityRole applicationRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,NormalizedName,ConcurrencyStamp")] IdentityRole applicationRole)
        {
